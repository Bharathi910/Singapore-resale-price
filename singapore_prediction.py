...
st.markdown("<h1 style='text-align: center; color: red;'>SINGAPORE RESALE FLAT PRICE PREDICTION</h1>",unsafe_allow_html=True)
...
if st.button('Predict Price'):
    with st.spinner(':Green[Loading....]'):
        def load_data():
            # Load data
            data = pd.read_csv("C:/Users/siva Bharathi/OneDrive/Desktop/Python/singapore_final.csv")
        ...
        st.success(f"Resale Price: :red[$] :green[{predicted_price}]")
